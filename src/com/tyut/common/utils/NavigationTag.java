...
writer.print("<li class=\"disabled\"><a href=\"#\" class=\"btn disabled\">" + "首页 </a></li>");
writer.print("<li class=\"disabled\"><a href=\"#\" class=\"btn disabled\">" + "上一页 </a></li>");
			}
			// 显示当前页码的前2页码和后两页码
...
writer.print("<li class=\"disabled\"><a href=\"#\" class=\"btn disabled\">" + "下一页</a></li>");
writer.print("<li class=\"disabled\"><a href=\"#\" class=\"btn disabled\">" + "尾页</a></li>");
			}
			writer.print("</nav>");
		} catch (IOException e) {
			e.printStackTrace();
